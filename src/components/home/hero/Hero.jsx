      ...
      <section className="relative bg-gradient-to-r from-violet-700 to-indigo-600 text-white rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center overflow-hidden">
        <div className="absolute top-0 left-0 bottom-0 right-0">
          ...
          <img
            src={Car}
            alt="car"
            className="w-full absolute top-20 left-40 h-full object-contain"
          />
        </div>
        ...
        <div className="md:w-2/3 z-10">
          ...
          <button class="mt-6 px-4 py-2 bg-orange-500 rounded-md cursor-pointer" onClick={navigateToAllCars}>
            View all cars
          </button>
        </div>
