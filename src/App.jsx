      ...
      <main className="max-w-6xl mx-auto px-6 pb-16">
        <section className="relative bg-gradient-to-r from-violet-700 to-indigo-600 text-white rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center overflow-hidden">
          ...
          <div className="md:w-2/3 z-10">
            ...
            <button className="mt-6 w-50 bg-orange-500 text-white rounded-md py-2 font-semibold">View all cars</button>
          </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col gap-2">
                      <div className="relative">
                        <label for="nom" class="">Rental date</label>
                        <input type="date" className="absolute inset-y-0 right-0 border rounded-md p-2 w-10"/>
                      </div>
                      <div className="relative">
                        <label for="nom" class="">Return date</label>
                        <input type="date" className="absolute inset-y-0 right-0 border rounded-md p-2 w-10" />
                      </div>
                </div>
